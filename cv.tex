...
\item Responsible for the \href{https://github.com/Anyline/anyline-ocr-anylinejs-module}{JS-OCR-SDK} development/releases (Typescript, wasm) \\
\end{itemize}
...
\noindent
{\bf Advocate of:} Functional/Reactive Programming, QA/Testautomation, Microservice Architecture,\\ 
 \tab \tab \smallspace event sourcing, small + frequent releases, auto documentation 
